...
<li class="active"><i class="material-icons">description</i>Agenda Guru</li>
</ol>
...
<!-- Inline Layout -->
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2><i class="material-icons">format_list_bulleted</i>AGENDA GURU</h2>
                        </div>
                        <div class="body">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="tgl" type="text" id="date" class="form-control" placeholder="Hari/Tanggal">
                                            </div>
                                        </div>
                                    </div>
                                      ...
                                      <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="absen" type="text" class="form-control" placeholder="Absen Siswa">
                                            </div>
                                        </div>
                                    </div>
